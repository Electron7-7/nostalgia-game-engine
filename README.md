...
# Building Nostalgia
#### Note for Windows users: there is currently no working DLL option, as it's much more complicated than building a shared library on Linux. If you can get it working before I do, please submit a pull request!
