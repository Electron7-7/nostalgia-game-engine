...
#include "../Nostalgia/theatre/parser/number_parser.hpp"
...
static void s_SetupNamesAndTypes(Farg<TokenArray>, TheatreFile::TheatreData2&);
static void s_ParseDeclaration(size_t&, Farg<TokenArray>, TheatreFile::TheatreData2&);
static TheatreFile::ThingData2 s_ParseThing(size_t&, Farg<TokenArray>, TheatreFile::TheatreData2&);
static bool s_CheckIfComment(Comment&, Farg<Token>);

Error TheatreFile::Parse(Farg<TokenArray> inTokens, Shared<TheatreData2> outData)
{
    ThingData     thing_dat{};
...
void s_SetupNamesAndTypes(Farg<TokenArray> inTokens, TheatreFile::TheatreData2& outData)
{
    std::string _type{};
    Comment in_comment{NO_COMMENT};
...
void s_ParseDeclaration(size_t& ioIndex, Farg<TokenArray> inTokens, TheatreFile::TheatreData2& outData)
{
...
TheatreFile::ThingData2 s_ParseThing(size_t& ioIndex,
    Farg<TokenArray> inTokens,
    TheatreFile::TheatreData2& outData)
{
    TheatreFile::ThingData2 thing_data{};
    ThingVariable2 thing_var{};
...
#pragma message("TODO: merge duplicate code")
                        thing_var.usage_flags |= VARIABLE_USAGE_BITMASK;
