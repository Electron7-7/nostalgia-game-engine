...
#include "math/conversion.hpp"                      // IWYU pragma: keep
#include "math/glm_concepts.hpp"                    // IWYU pragma: keep
#include "math/glm_format.hpp"                      // IWYU pragma: keep
#include "filesystem/filesystem.hpp"                // IWYU pragma: keep
#include "filesystem/file_data.hpp"                 // IWYU pragma: keep
#include "theatre/number_parser.hpp"                // IWYU pragma: keep
#include "theatre/thing_type.hpp"                   // IWYU pragma: keep
#include "theatre/variable_registry.hpp"            // IWYU pragma: keep
#include "theatre/thing_data.hpp"                   // IWYU pragma: keep
