...
bool MeshParser::CreateMeshData(std::vector<float>& ioVerts, std::vector<uint>& ioInds, const FileData& inData)
{
    ...
    case FileType::model_OBJ:
        return CreateOBJMesh(ioVerts, ioInds, inData);
...
bool MeshParser::CreateOBJMesh(std::vector<float>& ioVerts, std::vector<uint>& ioInds, const FileData& inData)
{
